...
// Starter code is by Dr. Min He on 3/14/2023.
...
// ain2 (PE1) 0 to 4095 <-- Left var
// ain9 (PE4) 0 to 4095 <-- Ahead var
// ain8 (PE5) 0 to 4095 <-- Right var
void Sensors_In(uint16_t *ain2, uint16_t *ain9, uint16_t *ain8){
	ADC0_PSSI_R = 0x0004; 								// 1) initiate SS2:0100
	while((ADC0_RIS_R & 0x04) == 0){}; 		// 2) wait for conversion done
	*ain2 = ADC0_SSFIFO2_R & 0xFFF; 			// 3) read results
	*ain9 = ADC0_SSFIFO2_R & 0xFFF;
	*ain8 = ADC0_SSFIFO2_R & 0xFFF;	
